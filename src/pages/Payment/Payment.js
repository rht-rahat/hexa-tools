...
const Payment = () => {
  ...
  const { data: order, isLoading } = useQuery(["purchase", id], () =>
    fetch(`https://hexa-tools-server.vercel.app/order/${id}`, {
      method: "GET",
      headers: {
            ...
            <div className="sticky top-20">
              <div className="flex gap-5">
                ...
                <div className="text-left">
                  ...
                  <span className="text-slate-400">Order#{order?._id}</span>
                  <span className="text-sm badge bg-base-300 border-0 text-black font-thin ">
                    {order?.status}
                  </span>
                  <h4 className="mt-5">Quantity: {order?.orderUnit} unit.</h4>
              ...
              <div className="bg-base-200 p-5 rounded-lg my-5 text-left">
                <h2 className="text-lg mb-5 font-bold">Shipping Details - </h2>
